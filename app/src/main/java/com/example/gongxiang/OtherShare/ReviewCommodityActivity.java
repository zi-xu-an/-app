...
import com.example.gongxiang.OtherShare.Adapter.ReviewAdapter;
import com.example.gongxiang.R;
import com.example.gongxiang.bean.Collection;
import com.example.gongxiang.bean.Review;
import com.example.gongxiang.util.MyCollectionDbHelper;
import com.example.gongxiang.util.ReviewDbHelper;
...
public class ReviewCommodityActivity extends AppCompatActivity {
    ...
    private void initview(){
        ...
        ibMyLove = findViewById(R.id.ib_my_love);
        etComment = findViewById(R.id.et_comment);
        lvReview = findViewById(R.id.list_comment);
        btnReview = findViewById(R.id.btn_submit);
